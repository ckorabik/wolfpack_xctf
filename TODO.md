# Wolfpack XC Site TODO

## Data synchronization

- [ ] Build a coach-triggered bulk sync from Google Sheets.
  - Import the `Team Timeline` tab into the History page.
  - Import the Varsity, Sophomore, and Freshman blocks from `Peoria Top 50`.
